...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">  })</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div></div></div><h3 id="json-schema-开发模式" tabindex="-1">JSON Schema 开发模式 <a class="header-anchor" href="#json-schema-开发模式" aria-label="Permalink to &quot;JSON Schema 开发模式&quot;">​</a></h3><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-jug7i" id="tab-mKLrAAM" checked="checked"><label for="tab-mKLrAAM">json-schema.vue</label><input type="radio" name="group-jug7i" id="tab-x1eP3Zx"><label for="tab-x1eP3Zx">transform-component.ts</label><input type="radio" name="group-jug7i" id="tab-BkyxnQl"><label for="tab-BkyxnQl">Input.ts</label><input type="radio" name="group-jug7i" id="tab-JJHTb1v"><label for="tab-JJHTb1v">FormItem.ts</label></div><div class="blocks"><div class="language-vue vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">script</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">lang</span><span style="color:#E1E4E8;">=</span><span style="color:#9ECBFF;">&quot;ts&quot;</span><span style="color:#E1E4E8;">&gt;</span></span>
<span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> Vue </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&quot;vue&quot;</span><span style="color:#E1E4E8;">;</span></span>
